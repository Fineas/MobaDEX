...
public class ProcessMoba extends AppCompatActivity {
    ...
    private void display_bundle_extras(Bundle tmp){
        ...
        Log.i("[MobaDEX]",builder.toString());
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(data.getString("moba_data") != null){
            ...
            tmp_bund.putExtra("moba_display_package","com.example.mobadex");
            tmp_bund.putExtra("moba_display_class","com.example.mobadex.ui.main.ShowMoba");
