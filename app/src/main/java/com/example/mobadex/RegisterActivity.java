...
public class RegisterActivity extends AppCompatActivity {
    ...
    int do_register(){
        ...
        // Log.d("[MobaDEX]","REGISTER USERNAME="+new_acc_username);
        // Log.d("[MobaDEX]","REGISTER PASSWORD="+new_acc_password);
        // Log.d("[MobaDEX]","REGISTER EMAIL="+new_acc_email);
        ...
        client.newCall(register_request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException { // REQUEST SUCCEED
                if(response.isSuccessful()){
                    ...
                    RegisterActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(myResponse.equals("Failed to connect to MySQL: ") ||
                                ...
                                Log.d("[MobaDEX]","Registering Succeeded.");
                    ...
                    Log.d("[MobaDEX]","Registering Failed.");
                }
            }
        });
